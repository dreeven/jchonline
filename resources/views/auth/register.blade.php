                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="naapMaternome" type="text" class="form-control @error('apMaterno') is-invalid @enderror" name="apMaterno" value="{{ old('apMaterno') }}" required autocomplete="apMaterno" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rol" type="numeric" class="form-control @error('rol') is-invalid @enderror" name="rol" value="{{ old('rol') }}" required autocomplete="rol" autofocus>
